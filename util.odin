...
// rand_int returns a random integer in [lo, hi] inclusive, matching glox's
// random.integer(min, max) semantics.
...
// rand_f32 returns a random float in [lo, hi), matching glox's
...
// world that wraps at world_width -- ported from npc.lox.
